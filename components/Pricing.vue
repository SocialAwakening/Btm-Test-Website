...
<div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
  ...
  <div class="relative xl:w-10/12 xl:mx-auto">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
      <div>
        <!-- Card -->
        <div class="p-4 relative z-10 bg-white border rounded-xl md:p-10 dark:bg-gray-800 dark:border-gray-700">
      ...
      <div>
        <!-- Card -->
        <div class="shadow-xl shadow-gray-200 p-5 relative z-10 bg-white border rounded-xl md:p-10 dark:bg-gray-800 dark:border-gray-700 dark:shadow-gray-900/[.2]">
